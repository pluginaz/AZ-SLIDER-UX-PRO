...
class AZSUX_Blog_Query {
     ...
     *
     * @param array $settings Slider settings or blog settings array
     * @return array Array of WP_Post objects
     */
    public static function get_posts( $settings = array() ) {
        $blog_settings = isset( $settings['blog'] ) && is_array( $settings['blog'] ) ? $settings['blog'] : $settings;
    ...
    /**
     * Build WP_Query args array from blog settings
     *
     * @param array $blog_settings
     * @return array
     */
    public static function build_query_args( $blog_settings = array() ) {
        $source = $blog_settings['source'] ?? 'dynamic';
        ...
        return apply_filters( 'azsux_blog_query_args', $query_args, $blog_settings );
    }

    /**
     * Query posts with args array
     *
     * @param array $query_args
     * @return array Array with 'posts' => array of WP_Post objects
     */
    ...
    protected static function get_manual_posts( $blog_settings ) {
        $args = self::build_query_args( $blog_settings );
        $res  = self::query_posts( $args );
        return $res['posts'];
    }
